...
a = p.activities.create(name:"Earthwork", amount: 100, rate: 10, crew_size: 5, duration: 10)
b = p.activities.create(name:"Excavation", amount: 100, rate: 10, crew_size: 5, duration: 12)
c = p.activities.create(name:"Formwork", amount: 100, rate: 10, crew_size: 5, duration: 9)
d = p.activities.create(name:"Foundations", amount: 100, rate: 10, crew_size: 5, duration: 5)
e = p.activities.create(name:"Electric", amount: 100, rate: 10, crew_size: 5, duration: 7)
f = p.activities.create(name:"Piping", amount: 100, rate: 10, crew_size: 5, duration: 6)
g = p.activities.create(name:"Mechanical", amount: 100, rate: 10, crew_size: 5, duration: 3)
h = p.activities.create(name:"HVAC", amount: 100, rate: 10, crew_size: 6, duration: 4)
i = p.activities.create(name:"Utilities", amount: 100, rate: 10, crew_size: 5, duration: 6)
Dependency.create([{ activity_id: b.id, predecessor_id: a.id},
                  { activity_id: b.id, predecessor_id: d.id },
                  { activity_id: e.id, predecessor_id: d.id },
                  { activity_id: e.id, predecessor_id: g.id },
                  { activity_id: h.id, predecessor_id: g.id },
                  { activity_id: c.id, predecessor_id: b.id },
                  { activity_id: f.id, predecessor_id: e.id },
